...
public interface StatementMapper {
  ...
  List<StatementTransaction> mapStatementTransactions(final List<Transaction> transaction);
  ...
  Statement mapStatement(final byte[] statementFile, final String extension);
}
